...
#for the assignment create a sequence from the first to last date of the dataset. From and to and specify timestamp (monthly,daily,yearly) to check for omitted. left join sequence of dates with data set. All the rows to be represented. and then run summary because it will populate with NAs.
