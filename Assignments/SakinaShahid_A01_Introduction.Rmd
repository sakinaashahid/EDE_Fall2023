...
> Answer: 
I feel confident in being able to troubleshoot problems within R and use the R interface.

3. Are there any components of the course about which you feel apprehensive?

> Answer: 
I haven't worked with large datasets so I feel apprehensive in regards to data wrangling. I also feel apprehensive about using GitHub since it is new to me.
