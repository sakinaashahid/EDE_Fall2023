...
# don't need "" because it is not a name

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.

NTL.phys.data.1990.1999 <- filter(NTL.phys.data,year4>=1990 & year4<=1999 & lakename == "Tuesday Lake")

# year4 %in% c(1990:1999) & lakename

```
Question: Why don't we filter using row numbers?

> Answer: Row filters numbers would change once we remove rows.
...
NTL.phys.data.Tuesday <- NTL.phys.data %>% filter(year4 %in% c(1990:199))  %>% 
