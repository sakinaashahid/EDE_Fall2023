...
```
 > Answer: It is not numeric because the concentration is describing a categorical variable. It is referring to the amount of active ingredient found in the formulation and is not continuous data.
...
> Answer: There are 12 plots sampled at Niwot Ridge. The unique function pulls 
